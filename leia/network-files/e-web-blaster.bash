docker run --name=opencms --restart=always --ip 172.19.0.222 --net hostnet -d -p 8084:8080 alkacon/opencms-docker:10.5.1
docker run -d -p 8089:80 --net hostnet special
sleep 35
